(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))e(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&e(n)}).observe(document,{childList:!0,subtree:!0});function t(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function e(a){if(a.ep)return;a.ep=!0;const o=t(a);fetch(a.href,o)}})();function x(s="auroraCanvas"){const i=document.getElementById(s);if(!i)return;const t=i.getContext("2d");if(!t)return;let e=i.width=window.innerWidth,a=i.height=window.innerHeight;const o=()=>{e=i.width=window.innerWidth,a=i.height=window.innerHeight};window.addEventListener("resize",o,{passive:!0});let n=0;function l(){n+=.003,t.clearRect(0,0,e,a),t.fillStyle="#09090b",t.fillRect(0,0,e,a);const b=e*.4+Math.sin(n*.7)*(e*.15),c=a*.25+Math.cos(n*.9)*(a*.1),f=Math.max(e,a)*.45,g=t.createRadialGradient(b,c,0,b,c,f);g.addColorStop(0,"rgba(56, 189, 248, 0.16)"),g.addColorStop(.5,"rgba(30, 58, 138, 0.08)"),g.addColorStop(1,"rgba(9, 9, 11, 0)"),t.fillStyle=g,t.fillRect(0,0,e,a);const v=e*.65+Math.cos(n*.8)*(e*.2),h=a*.35+Math.sin(n*.6)*(a*.12),w=Math.max(e,a)*.5,m=t.createRadialGradient(v,h,0,v,h,w);m.addColorStop(0,"rgba(99, 102, 241, 0.14)"),m.addColorStop(.5,"rgba(15, 23, 42, 0.06)"),m.addColorStop(1,"rgba(9, 9, 11, 0)"),t.fillStyle=m,t.fillRect(0,0,e,a);const d=e*.5+Math.sin(n*.5)*(e*.25),r=a*.65+Math.cos(n*.7)*(a*.15),u=Math.max(e,a)*.4,y=t.createRadialGradient(d,r,0,d,r,u);y.addColorStop(0,"rgba(16, 185, 129, 0.08)"),y.addColorStop(.5,"rgba(15, 23, 42, 0.04)"),y.addColorStop(1,"rgba(9, 9, 11, 0)"),t.fillStyle=y,t.fillRect(0,0,e,a),requestAnimationFrame(l)}l()}function S(){return`
  ...
  `}function M(){const s=document.getElementById("briefModalOverlay"),i=document.getElementById("modalCloseBtn"),t=document.getElementById("briefModalForm"),e=document.getElementById("modalSuccessState"),a=()=>{s==null||s.classList.add("open"),document.body.style.overflow="hidden"},o=()=>{s==null||s.classList.remove("open"),document.body.style.overflow=""};document.addEventListener("click",n=>{const l=n.target;l!=null&&l.closest(".trigger-brief-modal")&&(n.preventDefault(),a())}),i==null||i.addEventListener("click",o),s==null||s.addEventListener("click",n=>{n.target===s&&o()}),document.addEventListener("keydown",n=>{n.key==="Escape"&&(s!=null&&s.classList.contains("open"))&&o()}),t==null||t.addEventListener("submit",n=>{n.preventDefault(),t&&e&&(t.style.display="none",e.style.display="block")})}function A(){return`
  ...
  `}function I(){const s=document.getElementById("glassNav"),i=document.getElementById("mobileNavToggle"),t=document.getElementById("mobileNavMenu"),e=document.getElementById("mobileNavBackdrop");if(!s)return;let a=window.scrollY;window.addEventListener("scroll",()=>{const l=window.scrollY;l>60?l>a&&l-a>6?(s.classList.add("navbar-hidden"),s.classList.remove("navbar-visible")):a-l>6&&(s.classList.remove("navbar-hidden"),s.classList.add("navbar-visible")):(s.classList.remove("navbar-hidden"),s.classList.add("navbar-visible")),a=l},{passive:!0});const o=()=>{t==null||t.classList.add("open"),e==null||e.classList.add("open"),document.body.style.overflow="hidden"},n=()=>{t==null||t.classList.remove("open"),e==null||e.classList.remove("open"),document.body.style.overflow=""};i==null||i.addEventListener("click",()=>{t!=null&&t.classList.contains("open")?n():o()}),e==null||e.addEventListener("click",n),t==null||t.querySelectorAll("a, button").forEach(l=>{l.addEventListener("click",n)})}function E(){return`
  ...
  `}function L(){const s=document.getElementById("rotatingWordPill");if(!s)return;const i=["Revenue","ROAS","Pipeline","Acquisition","Conversion","Growth"];let t=0;setInterval(()=>{s.style.opacity="0",s.style.transform="translateY(-12px) scale(0.95)",setTimeout(()=>{t=(t+1)%i.length,s.textContent=i[t],s.style.transform="translateY(12px) scale(0.95)",requestAnimationFrame(()=>{s.style.opacity="1",s.style.transform="translateY(0) scale(1)"})},250)},2200)}function T(){return`
  ...
  `}function O(){let s="ecommerce";const i=document.querySelectorAll(".ind-tab-btn"),t=document.getElementById("indSectionTitle"),e=document.getElementById("indSectionDesc"),a=document.getElementById("indBadgeText"),o=document.getElementById("indQuoteText"),n=document.getElementById("indQuoteAuthor"),l=document.getElementById("chatAgentName"),b=document.getElementById("chatAgentPhone"),c=document.getElementById("chatMessagesScroll"),f=document.getElementById("chatPromptsBar"),g=document.getElementById("chatDemoForm"),v=document.getElementById("chatDemoInput");if(!i.length||!c)return;function h(d){const r=C[d];r&&(s=d,t&&(t.textContent=r.title),e&&(e.textContent=r.desc),a&&(a.textContent=r.badge),o&&(o.textContent=r.quote),n&&(n.textContent=r.author),l&&(l.textContent=r.agentName),b&&(b.textContent=r.agentPhone),c.innerHTML=r.initialMessages.map(u=>`
  ...
  `}function F(){const s=document.getElementById("businessSectorSelect"),i=document.getElementById("sliderVisitors"),t=document.getElementById("sliderConversion"),e=document.getElementById("sliderOrder"),a=document.getElementById("valVisitors"),o=document.getElementById("valConversion"),n=document.getElementById("valOrder"),l=document.getElementById("kpiLeads"),b=document.getElementById("kpiMonthlyRev"),c=document.getElementById("kpiLift"),f=document.getElementById("kpiAnnualRev");if(!i||!t||!e)return;const g={ecommerce:{order:85,min:25,max:1e3},b2b:{order:1500,min:300,max:5e3},clinics:{order:250,min:50,max:2e3},realestate:{order:3500,min:500,max:1e4},saas:{order:150,min:30,max:2500}};function v(){const h=parseInt(i.value,10),w=parseFloat(t.value),m=parseInt(e.value,10);a.textContent=Number(h).toLocaleString(),o.textContent=`${w.toFixed(1)}%`,n.textContent=`€${Number(m).toLocaleString()}`;const d=h*(w/100),r=35,u=Math.round(d*(r/100)),y=Math.round(u*m),k=y*12;l.textContent=`+${u.toLocaleString()}`,b.textContent=`+€${y.toLocaleString()}`,c.textContent=`+${r.toFixed(1)}%`,f.textContent=`€${k.toLocaleString()}`}s==null||s.addEventListener("change",()=>{const h=g[s.value];h&&(e.min=h.min,e.max=h.max,e.value=h.order,v())}),i.addEventListener("input",v),t.addEventListener("input",v),e.addEventListener("input",v),v()}function G(){return`
      ...
      <div class="container">
        <div class="cta-glow-card">
          ...
          <div style="display: flex; gap: 1rem; flex-wrap: wrap; justify-content: center; align-items: center; margin-top: 0.5rem;">
            ...
            <a href="https://wa.me/?text=Hello%20Vuvuzela%20DMF%2C%20I%20would%20like%20to%20learn%20more%20about%20your%20digital%20marketing%20services" target="_blank" rel="noopener noreferrer" class="btn-pill-secondary" style="padding: 0.95rem 1.8rem; font-size: 1.05rem;">
  ...
  `}class V{constructor(i="appRoot"){this.rootContainer=document.getElementById(i),this.transitionOverlay=document.getElementById("pageTransitionOverlay"),this.currentPath=this.normalizePath(window.location.pathname)}normalizePath(i){return"/"}init(){document.addEventListener("click",i=>{const t=i.target.closest("a");if(!t)return;const e=t.getAttribute("href");if(!e||e.startsWith("http")||e.startsWith("mailto:")||e.startsWith("tel:")||t.target==="_blank")return;if(e.startsWith("#")){i.preventDefault(),this.scrollToAnchor(e);return}const a=t.getAttribute("data-route")||e,o=this.normalizePath(a);if(o!==this.currentPath)i.preventDefault(),this.navigateTo(o);else if(e.includes("#")){i.preventDefault();const n=e.substring(e.indexOf("#"));this.scrollToAnchor(n)}}),window.addEventListener("popstate",()=>{this.renderRoute("/",!1)}),this.renderRoute("/",!1),window.location.hash&&setTimeout(()=>{this.scrollToAnchor(window.location.hash)},200)}navigateTo(i){this.isNavigating||(this.isNavigating=!0,this.transitionOverlay&&this.transitionOverlay.classList.add("is-active"),setTimeout(()=>{window.history.pushState({},"","/"),this.renderRoute("/",!0),window.scrollTo(0,0),setTimeout(()=>{this.transitionOverlay&&this.transitionOverlay.classList.remove("is-active"),this.isNavigating=!1},100)},220))}renderRoute(i,t){if(!this.rootContainer)return;let e="";e+=B(),document.title="VUVUZELA DMF — Digital Marketing Agency & Performance Growth Engine",e+=E(),e+=T(),e+=P(),e+=D(),e+=q(),e+=W(),e+=G(),e+=z(),this.rootContainer.innerHTML=e,I(),L(),R(),O(),F()}scrollToAnchor(i){const t=document.querySelector(i);if(t){const a=t.getBoundingClientRect().top+window.pageYOffset;window.scrollTo({top:Math.max(0,a-90),behavior:"smooth"})}}}document.addEventListener("DOMContentLoaded",()=>{x("auroraCanvas");const s=document.getElementById("modalMount");s&&(s.innerHTML=S(),M());const i=document.getElementById("whatsappMount");i&&(i.innerHTML=A()),new V("appRoot").init()});
